                    ...
                    <div class="panel form-element-padding">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                              ...
                              <g:form resource="${this.codeList}" onsubmit="ajxSubmit(jQuery(this),'content');return false;" method="PUT">
                                   ...
                                   <g:render template="details"/>
                                       ...
                                       <div class="form-group">
                                        <input class="submit btn btn-success pull-right"  type="button" value="${message(code: 'default.button.update.label', default: 'Update')}" />
