                ...
                <div class="col-md-12">
                    <div class="panel form-element-padding">
                        ...
                        <div class="panel-body">
                            <div class="col-md-12">
                                <g:link class="btn btn-primary pull-right" controller="receivePayment" action="index"  onclick="ajxCallItem(jQuery(this),'content');return false;">
                                    <i class="fa fa-arrow-left"></i>
                                    </g:link>
                                    <g:link class="btn btn-primary pull-right" onclick="ajxCallItem(jQuery(this),'content');return false;" 
                                        controller="receivePayment" action="create">
                            ...
                            <div class="col-md-12">
                                ...
                                <g:hasErrors bean="${this.receivePayment}">
                                    <ul class="errors" role="alert">
                                        <g:eachError bean="${this.receivePayment}" var="error">
                                            <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                                            </g:eachError>
                                    </ul>
                                </g:hasErrors>
                              <g:form resource="${this.receivePayment}" onsubmit="ajxSubmit(jQuery(this),'content');return false;" method="PUT">
                                    <g:hiddenField name="version" value="${this.receivePayment?.version}" />
