                ...
                <div class="col-md-12">
                    <div class="panel form-element-padding">
                        ...
                        <div class="panel-body">
                            <div class="col-md-12">
                                <g:link class="btn btn-primary pull-right" controller="purchasesMst" action="index"  onclick="ajxCallItem(jQuery(this),'content');return false;">
                                    <i class="fa fa-arrow-left"></i>
                                    </g:link>
                                    <g:link class="btn btn-primary pull-right" onclick="ajxCallItem(jQuery(this),'content');return false;" 
                                        controller="purchasesMst" action="create">
                            ...
                            <div class="col-md-12">
                              ...
                              <g:form resource="${this.purchasesMst}" onsubmit="ajxSubmit(jQuery(this),'content');return false;" method="PUT">
                                    <g:hiddenField name="version" value="${this.purchasesMst?.version}" />
