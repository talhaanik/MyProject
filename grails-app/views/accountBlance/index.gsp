...
<html>
    ...
    <body>
        <a href="#list-accountBlance" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="list-accountBlance" class="content scaffold-list" role="main">
