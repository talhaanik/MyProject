...
<html>
    ...
    <body>
        <a href="#create-accountBlance" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-accountBlance" class="content scaffold-create" role="main">
            ...
            <g:form action="save" onsubmit="ajxSubmit(jQuery(this),'menu_accountBlance');return false;">
                <fieldset class="form">
