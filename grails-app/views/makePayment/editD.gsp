...
<html>
    ...
    <body>
        <a href="#edit-makePayment" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-makePayment" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.makePayment}" onsubmit="ajxSubmit(jQuery(this),'menu_makePayment');return false;" method="PUT">
