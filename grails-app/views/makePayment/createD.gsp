...
<html>
    ...
    <body>
        <a href="#create-makePayment" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-makePayment" class="content scaffold-create" role="main">
            ...
            <g:form action="save" onsubmit="ajxSubmit(jQuery(this),'menu_makePayment');return false;">
                <fieldset class="form">
