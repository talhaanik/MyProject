                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <g:hasErrors bean="${this.stockItem}">
                                 ...
                                 <g:form  resource="${this.stockItem}" name="editFrm" method="PUT">
                <g:hiddenField name="version" value="${this.stockItem?.version}" />
                <fieldset class="form">
                    <%--f:all bean="stockItem"/--%>
                <g:render template="form"/>
                </fieldset>
                <fieldset class="buttons">
                    <input class="submit btn btn-success pull-right" onClick="submitfun();" type="button" value="${message(code: 'default.button.update.label', default: 'Update')}" />
                </fieldset>
            </g:form>
                            </div>
                            </div>
