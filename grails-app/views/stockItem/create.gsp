                    ...
                    <div class="panel form-element-padding">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <g:form action="save" name="editFrm">
                                       ...
                                       <div class="form-group">
                                        <input class="submit btn btn-success pull-right" onClick="submitfun();" type="button" value="${message(code: 'default.button.create.label', default: 'Create')}" />
                                       </div>
                                </g:form>
                            </div>
                            </div>
