    ...
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <li><g:link class="create" onclick="ajxCallItem(jQuery(this),'menu_${propertyName}');return false;" action="create"><g:message code="default.new.label" args="[entityName]" /></g:link></li>
            </ul>
        </div>
        <div id="edit-${propertyName}" class="content scaffold-edit" role="main">
            ...
            <g:form resource="\${this.${propertyName}}" onsubmit="ajxSubmit(jQuery(this),'menu_${propertyName}');return false;" method="PUT">
